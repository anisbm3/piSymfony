 ...
 */
class getCosplayRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CosplayRepository' shared autowired service.
     *
     * @return \App\Repository\CosplayRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CosplayRepository.php';

        return $container->privates['App\\Repository\\CosplayRepository'] = new \App\Repository\CosplayRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
