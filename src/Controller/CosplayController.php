...
{ #[Route('/', name: 'app_cosplay_index', methods: ['GET'])]
    ...
    #[Route('admin/{id}', name: 'app_cosplay_deleteb', methods: ['POST'])]
    public function deleteb(Request $request, Cosplay $cosplay, EntityManagerInterface $entityManager): Response
    {
